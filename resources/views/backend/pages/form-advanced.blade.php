                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="colorpicker-togglepaletteonly" value="#50a5f1">
                                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Datepicker</h4>
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input id="demo0" type="text" value="55" name="demo0"
                                            data-bts-min="0" data-bts-max="100" data-bts-init-val="" data-bts-step="1"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Value is set explicitly to 33 (skipping settings.initval)
                                        </label>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Css Switch</h4>
