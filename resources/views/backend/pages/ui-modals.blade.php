                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Modals Examples</h4>
                                ...
                                <h4 class="header-title mt-4">Modal Demos</h4>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#myModal">Modal demo</button>
                                                    ...
                                                    <div id="myModal" class="modal fade" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0" id="myModalLabel">Modal
                                                                        Heading</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl">Modal
                                                        demo</button>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0"
                                                                        id="myExtraLargeModalLabel">Extra large modal</h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal" aria-label="Close">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg">Modal
                                                        demo</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal" data-bs-target=".bs-example-modal-sm">Modal
                                                        demo</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-bs-target=".bs-example-modal-center">Modal demo</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#exampleModalScrollable">Modal demo</button>
                                                    ...
                                                    <div class="modal fade" id="exampleModalScrollable" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-scrollable">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0"
                                                                        id="exampleModalScrollableTitle">Scrollable Modal
                                                                    </h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal" aria-label="Close">
                                            ...
                                            <tr>
                                                <td>Static backdrop modal</td>
                                                <td>
                                                    <!-- Small modal -->
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal" data-bs-target=".staticBackdrop">Modal
                                                        demo</button>
                                                    ...
                                                    <div class="modal fade staticBackdrop" data-bs-backdrop="static"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>I will not close if you click outside me. Don't even
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary btn-sm waves-effect waves-light"
                                                        data-bs-toggle="modal"
                                                        data-bs-target=".exampleModalFullscreen">Modal demo</button>
                                                    ...
                                                    <div class="modal fade exampleModalFullscreen" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-fullscreen">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title mt-0"
                                                                        id="exampleModalFullscreenLabel">Fullscreen Modal
                                                                        Heading</h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal"
                                                                        aria-label="Close"></button>
