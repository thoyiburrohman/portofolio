                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">For custom Bootstrap form validation messages, you’ll need to add
                                    the <code>novalidate</code> boolean attribute to your <code>&lt;form&gt;</code>.</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">If your form layout allows it, you can swap the
                                    ...
                                    classes to display validation feedback in a styled tooltip.</p>
